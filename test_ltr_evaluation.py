...
class testLtrEvaluation(ut.TestCase):
    def test_eval_success(self) -> None:
        ...
        self.assertAlmostEqual(100, eval("(((100)))"), places=tol)
        self.assertAlmostEqual((1-11)*(2-22), eval("(1-11)*(2-22)"), places=tol)
        self.assertAlmostEqual(2.0 - (1.0*(.5 + 2e-1 + 0.0 + 1)*1.0), eval("2.0 - (1.0*(.5 + 2e-1 + 0.0 + 1)*1.0)"), places=tol)
        self.assertAlmostEqual(0.0 - (1.0 - 1000), eval("0.0 - (1.0 - 1000)"), places=tol)
        ...
        self.assertAlmostEqual((1E+1-1e+2)*(2.0 - 3.0e1), eval("(  (((1E+1-1e+2)*(2.0 - 3.0e1)    )) )"), places=tol)
        self.assertAlmostEqual(1-((((1e+4)))), eval("1-(((((1e+4)        ))))"),places=tol)
